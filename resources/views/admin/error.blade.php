...
<body>
    ...
    <div class="misc-wrapper">
        ...
        <h4 class="mb-2">{{ __('site.PageNotFound') }} ⚠️</h4>
        <p class="mb-4 mx-2">{{ __('site.PageNotFoundDesc') }}</p>
        <div class="d-flex justify-content-center mt-5">
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.dashboard') }}" class="btn btn-primary text-center my-4">
                        {{ __('site.BackToHome') }}</a>
                </div>
            </div>
        </div>
    </div>
