...
<head>
    ...
    <title>{{ __('login.AdminLogin') }}</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <p class="mb-4">{{ __('login.MessageLogin') }}</p>
                        ...
                        @if (session()->has('Add'))
                            <div class="alert alert-success" role="alert">{{ session()->get('Add') }}
                            </div>
                        @endif
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel2">
                                            {{ __('login.ForgetPassword') }}</h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>

                                    <form action="{{ route('admin.mail.reset.password') }}" method="POST">
                                        @csrf
                                                ...
                                                <div class="col mb-4 mt-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input name="email" type="email" id="Email"
                                                            class="form-control"
                                                            placeholder="{{ __('login.EnterEmail') }}" required />
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit"
                                                class="btn btn-primary">{{ __('login.Go') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
