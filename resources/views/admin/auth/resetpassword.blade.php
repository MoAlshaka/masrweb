...
<head>
    ...
    <title> {{ __('title.ChangePassword') }} </title>
                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5 mb-4">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-bold">{{ __('login.Fax') }}</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <!-- Reset Password -->
                    <div class="card-body">
                        ...
                        @endif
                        <h4 class="mb-2"> {{ __('login.ResetPassword') }} 🔒</h4>
                        <p class="mb-4"> {{ __('login.ResetPasswordText') }}</p>
                        <form id="formAuthentication" class="mb-3"
                            action="{{ route('admin.reset.password.store', $email) }}" method="POST">
                            @csrf
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="{{ __('login.EnterEmail') }}" autofocus />
                            ...
                            <div class="mb-3 form-password-toggle">
                                <div class="input-group input-group-merge">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <label for="new_password"> {{ __('login.NewPassword') }}</label>
                                    </div>
                                ...
                                <div class="input-group input-group-merge">
                                    <div class="form-floating form-floating-outline">
                                        <input type="password" id="confirm_password" class="form-control"
                                            ...
                                            placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                            aria-describedby="password" />
                                        <label for="confirm_password"> {{ __('login.ConfirmPassword') }}</label>
                                    </div>
                                    <span class="input-group-text cursor-pointer"><i
                                            class="mdi mdi-eye-off-outline"></i></span>
                                </div>
